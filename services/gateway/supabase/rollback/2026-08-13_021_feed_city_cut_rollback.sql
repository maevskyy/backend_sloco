-- Undo migration 021 (feed city hard cut). Restores feed_fallback_places from
-- migration 020 verbatim. Idempotent. Does not drop columns or data.
-- After running, redeploy the matching gateway version.
